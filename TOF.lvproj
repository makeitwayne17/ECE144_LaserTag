...
<Project Type="Project" LVVersion="17008000">
	...
	<Item Name="NI-myRIO-1" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="ArduinoToInt (SubVI).vi" Type="VI" URL="../ArduinoToInt (SubVI).vi"/>
		<Item Name="GetShotDistance(SubVI).vi" Type="VI" URL="../GetShotDistance(SubVI).vi"/>
		<Item Name="I2C LCD - Initialize.vi" Type="VI" URL="../I2C LCD - Initialize.vi"/>
		<Item Name="I2C LCD - Print String Array.vi" Type="VI" URL="../I2C LCD - Print String Array.vi"/>
		<Item Name="I2C LCD - Shutdown.vi" Type="VI" URL="../I2C LCD - Shutdown.vi"/>
		<Item Name="I2C LCD - Write Byte.vi" Type="VI" URL="../I2C LCD - Write Byte.vi"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="PopulateArray (SubVI).vi" Type="VI" URL="../PopulateArray (SubVI).vi"/>
		<Item Name="ScoreTracker(SubVI).vi" Type="VI" URL="../ScoreTracker(SubVI).vi"/>
		<Item Name="Servo Back and Forth(SubVI).vi" Type="VI" URL="../Servo Back and Forth(SubVI).vi"/>
		<Item Name="ServoRange(SubVI).vi" Type="VI" URL="../ServoRange(SubVI).vi"/>
